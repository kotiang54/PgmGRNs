...
2. SOS_data.csv : Normalized gene expression data for the SOS response regulatory network in ecoli.
	Genes in the order of columns: lexA, dinI, umuDC, recA, ssb, recF, rpoS,rpoH, rpoD
	
Order of genes in the recA_knockout_data.csv follows the order in SOS_data.csv.
